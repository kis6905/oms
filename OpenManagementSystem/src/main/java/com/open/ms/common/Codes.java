...
public class Codes {
	 ...
	 * 서비스 사용 여부 코드
	 */
	public static final int SERVICE_USE_YN_CODE_GROUP = 3;
	public static final int SERVICE_USE_YN_CODE_Y = 1301;
	public static final int SERVICE_USE_YN_CODE_N = 1302;
}