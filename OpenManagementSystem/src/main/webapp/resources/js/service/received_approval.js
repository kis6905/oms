...
$(document).ready(function() {
	...
	$('#approvalCancelBtn').on('click', function() { // 반려 버튼
 ...
 * 결재하기 or 반력하기
 */
function processingApproval(isCompletion) {
	...
	var statusCode = isCompletion ? '1202' : '1204';
...
function createPersonMoneybookDetailTable(data) {
	...
	detailTable = $('#personMoneybookTable').bootstrapTable({
		ajaxOptions: ajaxOption,
		method: 'post',
		url: '/service/received/approval/personmoneybook/list',
		contentType: 'application/json',
		dataType: 'json',
		queryParams: function(params) {
//			location.href = '#';
