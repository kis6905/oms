...
CREATE TABLE `oms_service` (
  ...
  CONSTRAINT `fk_oms_service_oms_role1` FOREIGN KEY (`roleId`) REFERENCES `oms_role` (`roleId`) ON DELETE CASCADE ON UPDATE CASCADE
