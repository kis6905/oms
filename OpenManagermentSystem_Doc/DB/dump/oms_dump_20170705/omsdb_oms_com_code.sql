...
INSERT INTO oms_com_code VALUES (0,1001,'Admin','1001'),(0,1002,'User','1002'),(1,1101,'비밀번호 오류 횟수 한계','10'),(2,1201,'결재 상태 코드(대기)','1201'),(2,1202,'결재 상태 코드(완료)','1202'),(2,1203,'결재 상태 코드(철회)','1203'),(2,1204,'결재 상태 코드(반려)','1204'),(3,1301,'서비스 사용 여부(사용)','1301'),(3,1302,'서비스 사용 여부(사용안함)','1302');
